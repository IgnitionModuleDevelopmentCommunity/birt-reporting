...
public class PDFViewerComponentBeanInfo extends CommonBeanInfo{
    ...
    protected void initProperties() throws IntrospectionException {
        ...
        addProp("pageFitMode", "Page Fit Mode", "Page Fit Mode", CAT_APPEARANCE, PREFERRED_MASK | BOUND_MASK);
        addProp("pageViewMode", "Page View Mode", "Page View Mode", CAT_APPEARANCE, PREFERRED_MASK | BOUND_MASK);
    ...
    protected void initDesc() {
        ...
        bean.setShortDescription("PDF Viewer Component for Ignition");
    }
